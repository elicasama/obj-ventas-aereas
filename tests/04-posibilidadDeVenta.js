...
describe("Permitir la venta según criterio", () => {
  ...
  describe("Segura", () => {
    it("Se puede vender si hay más de 3 asientos libres", () => {
      for (i = 0; i < 2; i++) {
        vueloDePasajeros.venderPasaje("22-03-2021", 26581333); // dejamos 98 asientos libres
      }
    ...
    it("No se puede vender si hay menos de 3 asientos libres", () => {
      for (i = 0; i < 97; i++) {
        vueloDePasajeros.venderPasaje("22-03-2021", 26581333); // dejamos menos de 3 asientos libres
      }
